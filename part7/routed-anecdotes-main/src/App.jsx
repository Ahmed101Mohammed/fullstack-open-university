...
const Anecdote = ({ anecdote }) => 
{
  ...
  return  (
    <Link to={`/anecdotes/${anecdote.id}`} style={linkStyling}>{ anecdote.content }</Link>
  )
}
...
const App = () => {
  ...
  const targetAnecdote = id? anecdotes.find(anecdote => anecdote.id === id) : null
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path='/anecdotes/:id' element={<AnecdoteSingleView anecdote={targetAnecdote}/>} />
